...
def writeblockmeshdict(pointlist,hexblocks,arclist,boundlist,mergepatches):
    ...
    blockMeshDict.write( "\nvertices\n(\n")
    for point in pointlist: blockMeshDict.write( "    ("+format(point[0])+" "+format(point[1])+" "+format(point[2])+") //"+repr(pointlist.index(point))+"\n")
...
# 
createboundary("symmetryleft",[[s1,a1],[p5,s1],[s5,p1],[o1,s5],[p1,p0],[p0,p5]],l,"symmetry")
createboundary("symmetryrigt",[[a2,s2],[s2,s3],[s3,o2]],l,"symmetry")

createboundary("Outlet",[[a1,s1,s2,a2],[p5,p4,s2,s1],[p4,p3,s3,s2],
   [p3,p2,s4,s3],[p2,p1,s5,s4],[s4,o3,o2,s3],[o1,o3,s4,s5],
   [p0,p1,p2,p0],[p0,p2,p3,p0],[p0,p3,p4,p0],[p0,p4,p5,p0]],l[0],"patch")

createboundary("Inlet",[[a2,s2,s1,a1],[s1,s2,p4,p5],[s2,s3,p3,p4],
    [s3,s4,p2,p3],[s4,s5,p1,p2],[s4,s3,o2,o3],[s5,s4,o3,o1],
    [p0,p2,p1,p0],[p0,p3,p2,p0],[p0,p4,p3,p0],[p0,p5,p4,p0]],l[-1],"patch")

createboundary("fluid_to_cilcen",[[a1,a2]],l,"patch")
#createboundary("fluid_to_ciltop",[[p1,p2],[p2,p3],[p3,p4],[p4,p5]],l,"patch")

...
dg     = math.pi*2.5/180          # Degree of the mesh (45o)
l      = [0,-1500]                 # Levels of the Mesh
...
exp    = [25,107]                 # Number of points in the mesh and their refinement [27,12] [50,107]

#points for the center cylinder
c0 = [0,0]
a1 = [ r*math.cos(dg), -r*math.sin(dg)]
a2 = [ r*math.cos(dg),  r*math.sin(dg)]

#points for the outter wall
o1 = [ R*math.cos(dg),  -R*math.sin(dg)]
o2 = [ R*math.cos(dg),   R*math.sin(dg)]


#Define Hexblocks input
for x in xrange(0,len(l)-1):
    createHexBlock(a1,o1,o2,a2,l[x],l[x+1], [exp[0],lpi/36,lf[0][x]], [exp[1],1,lf[1][x]])  # boundary layer cen cilinder    
...
createboundary("symmetryleft1",[[o1,a1]],l,"empty")
createboundary("symmetryrigt1",[[a2,o2]],l,"empty")

createboundary("Outlet",[[a1,o1,o2,a2]],l[0],"patch")
createboundary("Inlet",[[a2,o2,o1,a1]],l[-1],"patch")

createboundary("fluid_to_cilcen",[[a2,a1]],l,"patch")
